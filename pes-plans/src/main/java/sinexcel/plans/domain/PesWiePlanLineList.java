...
/**
 * 生产计划行对象 pes_wie_plan_line_list
 * 
 * @author Zhang Kai
 * @date 2020-11-25
 */
public class PesWiePlanLineList
{
    ...
    private BigDecimal planWieQuantity;
...
//    @Excel(name = "累计需求", width = 10, cellType = Excel.ColumnType.BigDecimal)
    ...
    @Excel(name = "补货点", width = 10, cellType = Excel.ColumnType.BigDecimal)
    ...
    /** 主计划数量 */
    @Excel(name = "主计划数量", width = 10, cellType = Excel.ColumnType.BigDecimal)
    ...
    private BigDecimal llc;
    private BigDecimal netQuantity;
    private BigDecimal biaoComponentQuantity;
    private BigDecimal totalDays;
    private BigDecimal planNetQuantity;

    public BigDecimal getPlanNetQuantity() {
        return planNetQuantity;
    }

    public void setPlanNetQuantity(BigDecimal planNetQuantity) {
        this.planNetQuantity = planNetQuantity;
    }
    ...
    public void setPlanWieQuantity(BigDecimal planWieQuantity) 
    {
        this.planWieQuantity = planWieQuantity;
    }

    public BigDecimal getPlanWieQuantity() 
    {
