 ...
 * @date 2021-06-07
 */
public class PesProdLineDaysLineAllWWPrice extends BaseEntity
{
    ...
    public BigDecimal getQeductionQuantity() {
        return qeductionQuantity;
    }

    public void setQeductionQuantity(BigDecimal qeductionQuantity) {
        this.qeductionQuantity = qeductionQuantity;
    }

    public Date getQeductionDate() {
        return qeductionDate;
    }

    public void setQeductionDate(Date qeductionDate) {
        this.qeductionDate = qeductionDate;
    }
