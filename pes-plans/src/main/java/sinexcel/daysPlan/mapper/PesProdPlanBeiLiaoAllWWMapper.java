 ...
 * @date 2021-06-16
 */
public interface PesProdPlanBeiLiaoAllWWMapper
{
    ...
    public int insertPesProdPlanBeiLiaoAll(PesProdPlanBeiLiaoAllWW pesProdPlanBeiLiaoAll);
     ...
     * @return void
     **/
    void updateTransferStart(PesProdPlanBeiLiaoAllWW info);
