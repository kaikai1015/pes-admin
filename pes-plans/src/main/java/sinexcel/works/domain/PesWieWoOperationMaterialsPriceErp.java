 ...
 * @date 2021-11-26
 */
public class PesWieWoOperationMaterialsPriceErp
{
    ...
    public BigDecimal getSubSumUnitCost() {
        return subSumUnitCost;
    }

    public void setSubSumUnitCost(BigDecimal subSumUnitCost) {
        this.subSumUnitCost = subSumUnitCost;
    }
