...
import sinexcel.quartz.mapper.SysJobMapper;
import sinexcel.quartz.service.ISysJobService;
import sinexcel.quartz.util.CronUtils;
import sinexcel.quartz.util.ScheduleUtils;
...
public class SysJobServiceImpl implements ISysJobService
{
    ...
    @Override
    public void reStart() throws SchedulerException, TaskException
    {
        Date Num = new Date();
        scheduler.clear();
        jobMapper.updateJobAll(Long.valueOf(sdf.format(Num)));
        List<SysJob> jobList = jobMapper.selectJobAll();
        for (SysJob job : jobList)
        {
            ScheduleUtils.createScheduleJob(scheduler, job);
    ...
    public int insertJob(SysJob job) throws SchedulerException, TaskException
    {
        job.setStatus(ScheduleConstants.Status.PAUSE.getValue());
        Date Num = new Date();
        job.setReStartId(Long.valueOf(sdf.format(Num)));
