 ...
 * 
 */
@WebServiceClient(name = "ReportService", targetNamespace = "http://xmlns.oracle.com/oxp/service/v2", wsdlLocation = "https://ehsj-test.fa.ap1.oraclecloud.com/xmlpserver/services/v2/ReportService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL(ConfigUtils.getBiServer()+"/xmlpserver/services/v2/ReportService?wsdl");
