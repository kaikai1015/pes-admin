 ...
 * 
 */
@WebServiceClient(name = "ESSWebService", targetNamespace = "http://xmlns.oracle.com/scheduler", wsdlLocation = "https://ehsj-test.fa.ap1.oraclecloud.com/ess/esswebservice?WSDL")
public class ESSWebService_Service
    extends Service
{
    ...
    public ESSWebService getSchedulerServiceImplPort() {
        return super.getPort(new QName("http://xmlns.oracle.com/scheduler", "SchedulerServiceImplPort"), ESSWebService.class);
    }
    ...
    public ESSWebService getSchedulerServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://xmlns.oracle.com/scheduler", "SchedulerServiceImplPort"), ESSWebService.class, features);
    }
